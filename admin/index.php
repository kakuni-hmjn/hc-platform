    ...
    <section class="section admin-section">
        <div class="container">
            ...
            <div class="admin-menu-grid">
                ...
                <a href="/admin/game-plans/" class="admin-menu-card reveal">
                    <span>07</span>
                    <h3>ゲームサーバープラン管理</h3>
                    <p>ゲームサーバーレンタルの料金、スペック、Pterodactyl連携情報を管理します。</p>
                </a>
                ...
                <a href="/admin/server-orders/" class="admin-menu-card reveal">
                    <span>09</span>
                    <h3>ゲームサーバー申込管理</h3>
                    <p>
                        ゲームサーバーレンタルの申込、決済状態、作成状態、キャンセル申請を確認します。
                    </p>
                </a>
